    ...
    return (
      ...
      >
        ...
        <div className="relative py-8">
          <div
            className="absolute top-[-22px] -ml-4 w-8 h-8 flex items-center justify-center bg-blue-900 text-white text-[12px] font-medium rounded-full opacity-0 scale-75 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300 ease-out z-30 pointer-events-none shadow-[0_4px_10px_rgba(10,10,15,0.25)]"
