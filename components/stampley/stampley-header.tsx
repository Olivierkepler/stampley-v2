...
>
        ...
        <div className="min-w-0">
          <h1 className="truncate text-[11px] font-semibold tracking-[-0.02em] text-blue-900 md:text-[15px]">
            {title}
          </h1>

          {subtitle && (
            <p className="hidden text-[11px] text-black/40 md:block">
              {subtitle}
            </p>
          )}
        </div>
  ...
  className="group flex cursor-pointer items-center gap-2  bg-white px-3.5 py-2 text-[14px] font-medium text-black  transition-all duration-200 hover:-translate-y-[1px] hover:text-black active:translate-y-0"
  style={{ fontFamily: "'Poppins', sans-serif" }}
>
  <LogOut
    size={14}
